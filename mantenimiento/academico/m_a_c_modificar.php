<?php
	...
	$id = $_GET['IDCiclo'];
	$sql = "SELECT * FROM tbl_ciclos1 WHERE IDCiclo = '$id'";
...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="m_a_c_update.php" autocomplete="off">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="m_a_ciclo.php" class="btn btn-default">Regresar</a>
