...
<html lang="es">
	...
	<body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="POST" action="m_a_cu_p_guardar.php" autocomplete="off">
                    ...
                    <tbody>
                        <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                            ...
                            <td><?php echo $row['IDCursos'];?></td>
                                ...
                                <td><a href="m_a_cu_p_modificar.php?IDCursos=<?php echo $row['IDCursos']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
