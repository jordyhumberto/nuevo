<?php
	...
	$sql = "SELECT * FROM distritos ORDER BY Nom_Dist";
		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="m_a_d_guardar.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="categoria" name="categoria" placeholder="MAESTRIA/DOCTORADO EN" required>
					</div>
				</div>
				<div class="form-group">
					<label for="regimen" class="col-sm-2 control-label">Régimen</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="regimen" name="regimen" placeholder="MAÑANA/TARDE O NOCHE">
					</div>
				</div>
				<div class="form-group">
