<?php
	...
	$id = $_GET['IDTA'];
	$sql = "SELECT * FROM tbl_tipo_aula1 WHERE IDTA = '$id'";
...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="m_a_t_a_update.php" autocomplete="off">
				<input type="hidden" id="id" name="id" value="<?php echo $row['IDTA']; ?>" />
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="m_a_tipo_aula.php" class="btn btn-default">Regresar</a>
