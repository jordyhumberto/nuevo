<?php
	...
	$sql = "SELECT tbl_notas_alumno.IDMatricula as matricula,
	tbl_matricula_carrera1.IDAlumno as alumno,
	tbl_semestre1.Descripcion as semestre,
	tbl_cursos1.IDCiclo as ciclo,
	tbl_cursos1.Descripcion as curso,
	tbl_docente1.Nombres as nombre,
	tbl_docente1.Apellidos as apellido,
	tbl_notas_alumno.PPracticas as practicas,
	tbl_notas_alumno.ExamenParcial as parcial,
	tbl_notas_alumno.ExamenFinal as final,
	tbl_notas_alumno.ExamenSusti as susti,
	tbl_notas_alumno.Promedio as promedio
	  FROM (((((tbl_notas_alumno INNER JOIN tbl_curso_operativo ON tbl_notas_alumno.IDCO=tbl_curso_operativo.IDCO) INNER JOIN tbl_docente1 ON tbl_curso_operativo.IDDocente=tbl_docente1.IDDocente) INNER JOIN tbl_cursos1 ON tbl_curso_operativo.IDCursos=tbl_cursos1.IDCursos ) INNER JOIN tbl_semestre1 ON tbl_curso_operativo.IDSemestre=tbl_semestre1.IDSemestre) INNER JOIN tbl_matricula_carrera1 ON tbl_notas_alumno.IDMatricula=tbl_matricula_carrera1.IDMatricula)
	  WHERE tbl_matricula_carrera1.IDAlumno='$id' $where";
